...
b.addEventListener('click', () => {
    ...
    let p = document.querySelector("#examples-button");
    p.addEventListener('click', () => {
        ...
        document.querySelector('#examples').classList.add('visible');
    });
...
function resetIframe() {
    var quizIframe = document.getElementById('quiz_iframe');

    if (quizIframe) {
        // Ξαναφορτώνει το iframe, κάνοντας reset το παιχνίδι
        quizIframe.src = quizIframe.src;
    }
}

// Εντοπίζει το κουμπί και προσθέτει event για το reset
